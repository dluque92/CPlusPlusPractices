...
<body>
	...
	<table border=0 align="center">
		...
		<tr>
			...
			<td align="center"><input type="text" style="text-align:center" name="apellido" id="apellidosEP" value="<%=p.getApellidos()%>"></td>
			...
			<td align="center"><input type="text" style="text-align:center" name="idAsignatura" id="idAsignaturaEP" value="<%=p.getIdAsignatura()%>"></td>
